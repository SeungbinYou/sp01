...
<body>
 ...
 <div>
 Title <input type='text' name='title' readonly="readonly" value="${todo.title }">
 </div>
 <div>
 Writer <input type='text' name='writer'readonly="readonly" value="${todo.writer }">
 </div>
 <div>
 ...
 <div>
   ...
   <input id='replyer' type='replyer' name="replyer" value='tester'>
...
<script>
  ...
  $(".modBtn").on("click", function(e){
	  ...
	  var data = { reply:$(".popup input[name='reply']").val() , replyer:$(".popup input[name='replyer']").val() };
  ...
  $("#replyBtn").click(function(e){
	  ...
	  var data = { reply:$("#reply").val() , replyer:$("#replyer").val(), tno:44 };
