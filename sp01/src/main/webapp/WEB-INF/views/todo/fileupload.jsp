...
<!-- Bootstrap core CSS -->
<link
	href="/resources//resources/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
...
<body>
	...
	<div class="container">
		<a class="navbar-brand" href="#">Image Registration </a>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item"><a class="nav-link" href="/list">Main</a></li>
